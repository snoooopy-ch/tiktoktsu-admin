...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_goldex' => [
            'driver' => 'mysql',
            'host' => env('DB_GOLDEX_HOST', '127.0.0.1'),
            'port' => env('DB_GOLDEX_PORT', '3306'),
            'database' => env('DB_GOLDEX_DATABASE', 'forge'),
            'username' => env('DB_GOLDEX_USERNAME', 'forge'),
            'password' => env('DB_GOLDEX_PASSWORD', ''),
            'unix_socket' => env('DB_GOLDEX_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'timezone' => '+00:00',
            'prefix' => '',
