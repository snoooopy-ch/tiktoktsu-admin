...
@section('title', "$tiktokInfo->uniqueId 詳細")
                    ...
                    <div class="card text-center bg-transparent">
                        <div class="card-content pl-sm-2 pr-sm-2 pl-0 pr-0">
                            ...
                            <div class="card-body p-0">
                                <h4 class="card-title">{{ number_format($tiktokInfo->follercount) }}人</h4>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                    <div class="card text-center bg-transparent">
                        <div class="card-content pl-sm-2 pr-sm-2 pl-0 pr-0">
                            ...
                            <i class="feather icon-users float-left pl-sm-2 pl-0" style="font-size: 46px"></i>
                            <div class="card-body p-0">
                                <h4 class="card-title mt-2">{{ number_format($tiktokInfo->followingcount) }}人</h4>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                    <div class="card text-center bg-transparent">
                        <div class="card-content pl-sm-2 pr-sm-2 pl-0 pr-0">
                            ...
                            <div class="card-body p-0">
                                <h4 class="card-title">{{ number_format($tiktokInfo->heart) }}回</h4>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                    <div class="card text-center bg-transparent">
                        <div class="card-content pl-sm-2 pr-sm-2 pl-0 pr-0">
                            ...
                            <div class="card-body p-0">
                                <h4 class="card-title mt-2">{{ number_format($tiktokInfo->videocount) }}個</h4>
                                <p class="card-text mb-25">&nbsp;</p>
                            </div>
                        </div>
                    </div>
