...
@section('contents')
    <div class="row" id="div-main">
        <div class="col-md-12 col-lg-12">
            ...
            @endif
            <form action="{{ route('tiktok.category.add') }}" method="POST" enctype="multipart/form-data" class="mb-2">
                @csrf
                <div class="row">
...
@section('scripts')
    ...
    <script>
        ...
        categoryTable = $('#category-list').DataTable({
            ...
            searching: true,
            ajax: {
                url: BASE_URL + 'api/tiktok/getcategories',
                type: 'POST',
            },
            columnDefs: [{
                'targets': 0,
        ...
        $('#confirm_delete_agree').click(function(e) {
            ...
            $.get({
                url: BASE_URL + 'api/deletetiktokcategory/' + id,
        ...
        $('#confirm_modify_agree').click(function(e) {
            ...
            var name = $('#modal_modify-category').val();
            $.post({
                url: BASE_URL + 'api/modifytiktokcategory/' + id,
                data: {
                    name: name
                },
                success: function(result) {
